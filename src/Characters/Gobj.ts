...
export default class Gobj{
    ...
    x;y; width; height; action; status; buffer; override; bufferObjs;allFrames;team;frame;dieEffect;processing; sound;burrowBuffer;selected

    constructor({x=0,y=0,target = null,team=0}={}){
        this.x=x;
        this.y=y;
    ...
    inside(...args){
        return this.insideCircle(args[0]);
    };
    //Radius
    radius(){
